        ...
        <div class="col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?= form_open_multipart('admin/gudang/stuffEdit/' . $stok['id_barang']); ?>
                    <div class="form-group row">
                        <label for="id_barang" class="col-sm-2 col-form-label">Id Barang</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="id_barang" name="id_barang" value="<?= $stok['id_barang'] ?>" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-3">
                                    <img src="<?= base_url() ?>image/barang/<?= $stok['foto'] ?>" class="img-thumbnail">
                                </div>
                                <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <label for="formGroupExampleInput"><b>Current: <?= $stok['nama_tipepenjualan'] ?></b></label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="harga_beli" name="harga_beli" value="<?= $stok['harga_beli'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="harga_jual" name="harga_jual" value="<?= $stok['harga_jual'] ?>">
